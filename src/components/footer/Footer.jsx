...
const Footer = () => {
  return (
    <footer>
      <a href="#home" className="footer__logo" >Vikrant Kumar Singh</a>
      ...
      <div className="footer__socials">
        ...
        <a href="https://github.com/vikrants10" target="_blank" rel="noopener, noreferrer"><BsGithub /></a>
        <a href="https://www.linkedin.com/in/vikrant-kumar-singh-0a636524a/" target="_blank" rel="noopener, noreferrer"><BsLinkedin /></a>
      </div>

      <div className="footer__copyright">
        <small> &#169; Vikrant Kumar Singh</small>
      </div>
    </footer>
